...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.imageView.image = [UIImage imageWithData:info.icon];
}
...
- (NSFetchedResultsController *)fetchedResultsController {
    ...
    NSEntityDescription *entity = [NSEntityDescription
                                   entityForName:@"TemplateType" inManagedObjectContext:_managedObjectContext];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
     ...
     */
    TemplateType *info = [_fetchedResultsController objectAtIndexPath:indexPath];
    [_passValueDelegate valueHasChosen:info];
